                ...
                @foreach ($category_movies as $category_movie)
                    <section id="halim-advanced-widget-2">
                        <div class="section-heading">
                            <a href="danhmuc.php" title="{{ $category_movie->name }}">
                                <span class="h-text">{{ $category_movie->name }}</span>
                            </a>
                        </div>
                        <div id="halim-advanced-widget-2-ajax-box" class="halim_box">
                            @if (count($category_movie->movie) > 0)
                                    ...
                                    <article class="col-md-3 col-sm-3 col-xs-6 thumb grid-item post-37606">
                                        <div class="halim-item">
                                            <a class="halim-thumb" href="{{ route('movie.detail', ['slug'=>$amovie->slug]) }}">
                                                ...
                                                <div class="halim-post-title-box">
                                                    <div class="halim-post-title ">
                                                        <p class="entry-title">{{$amovie->name}}</p>
                                                        <p class="original_title">{{$amovie->name_eng}}</p>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
